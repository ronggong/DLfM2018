    ...
    for config in configs:
        ...
        for ii in range(5):
            file_path_model = os.path.join(path_model,
                                           model_name + '_teacher_student' + '_' + attention_dense_str + str(
                                               ii) + '.h5')
            file_path_log = os.path.join(path_model, 'log',
                                         model_name + '_teacher_student' + '_' + attention_dense_str + str(ii) + '.csv')
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="To reproduce the experiment results of overall quality embedding.")
